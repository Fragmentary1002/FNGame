...
public class BasicMove : GenericBehaviour
{
    ...
    private bool isNav = false; // 判断是否按下E键
    //private float speedSeekerBeforeJump;
    ...
    void Update()
    {
        ...
        if (isNav && targetObject != null && behaviourManager.IsCurrentBehaviour(this.behaviourCode) && !behaviourManager.IsOverriding())
        {
    ...
    void JumpManagement()
    {
        ...
        if (jump && !behaviourManager.GetAnim.GetBool(jumpBool) && behaviourManager.IsGrounded())
        {
            ...
            //speedSeekerBeforeJump = speedSeeker; // 记录跳跃前的速度
        ...
        else if (behaviourManager.GetAnim.GetBool(jumpBool))
        {
            ...
            if ((behaviourManager.GetRigidBody.velocity.y < 0) && behaviourManager.IsGrounded())
            {
                ...
                //speedSeeker = speedSeekerBeforeJump;
            }
        }
    }
    ...
    void NavigateToTarget()
    {
        ...
        {
            // 让玩家先面向目标
            /*Vector3 lookPos = targetObject.transform.position - transform.position;
            //lookPos.y = 0;
